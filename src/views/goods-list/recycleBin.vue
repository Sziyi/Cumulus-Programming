<template>
  <div>
    <el-card shadow="never" style="border: none">
      ...
      <el-button :size="size" type="warning">恢复商品</el-button>
      <el-button :size="size" type="danger">彻底删除</el-button>
      <el-tooltip
        class="box-item"
        effect="dark"
        content="刷新数据"
      ...
      >
        ...
        <el-table-column class="button" label="操作">
          <template #default>
            <el-button link type="primary" size="small">暂无操作</el-button>
          </template>
        </el-table-column>
      </el-table>
      <el-pagination
...
const recycleBin = async () => {
  const res = await store.dispatch('user/recycleBin')
  //   console.log(res)
